...
while True:
    try:
            ...
            def terminal_custom(cmd="", is_ia=False):
                show_nebula()
                while True:
                    ...
                    if cmd == "exit": # Exit the terminal
                        ...
                        print("  nexariescan       - Lancer le scan Nexari (XSS & liens)")
                        ...
                        print("  nebula_ia        - L'IA du NTC (CETTE VERSION EST EN COURS DE DEVELOPPEMENT !!!)")
                        print("  nebula_ia_install- Install Nebula IA")
                        print("  clean            - netoie le system")
                        print("  filmux           - permet de regarde n'importe quel film")
                        ...
                        print(Fore.RED + "Lancement de Nebula IA...")
                        nebula_module.launch()  # ici launch() correspond à la boucle principale
                    elif cmd == "nebula_ia_install":
                        ...
                        print("sa ne marhce pas encore patiente !")
